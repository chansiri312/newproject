                                            ...
                                            <v-sheet class="form mx-auto" elevation="1" max-width="900" min-height="500"
                                                ...
                                                <div class="forminput">
                                                    ...
                                                    <v-col class="text-center" style="margin-bottom: 1rem">
                                                        <h3>แบบบันทึกข้อมูลประวัติการให้ผลผลิต(รายฟาร์ม)</h3>
                                                    </v-col>
                                                    <v-row>
                                                        <v-col>
                                                            <v-text-field label="กรอกหมายเลขประจำตัว" type="text"
                                                                variant="outlined"
                                                                v-model="recipe.ingredient1"></v-text-field>
                                                        </v-col>
                                                        <v-col>
                                                            <v-text-field label="กรอกชื่อพันธุ์แพะนม" type="text"
                                                                variant="outlined"
                                                    ...
                                                    <v-row>
                                                        <v-col>
                                                            <v-text-field label="กรอกจำนวนวันให้ผลผลิต(วัน)" type="text"
                                                                variant="outlined"
                                                                v-model="recipe.ingredient3"></v-text-field>
                                                        </v-col>
                                                        <v-col>
                                                            <v-text-field label="กรอกปริมาณน้ำนม(Kg)" type="text"
                                                                variant="outlined"
...
function showMyData() {
    if (user !== null) {
        user.providerData.forEach(async (profile) => {
            ...
            const q = query(collection(db, 'addhistoryData'), where('useremail', '==', userEmail))
