                                        ...
                                        <div class="text">
                                            <v-sheet class="form mx-auto" elevation="1" max-width="900" min-height="500"
                                                ...
                                                <div class="forminput">
                                                    ...
                                                    <v-row>
                                                        <v-col>
                                                            <v-text-field label="กรอกข้อมูลเรื่องที่ฝึกอบรม" type="text"
                                                                variant="outlined"
                                                                v-model="recipe.ingredient1"></v-text-field>
                                                        </v-col>
                                                        <v-col>
                                                            <v-text-field label="กรอกข้อมูลวันที่ฝึกอบรม" type="text"
                                                                variant="outlined"
                                                    ...
                                                    <v-row>
                                                        <v-col>
                                                            <v-text-field label="กรอกข้อมูลระยะเวลาในการฝึกอบรม" type="text"
                                                                variant="outlined"
                                                                v-model="recipe.ingredient3"></v-text-field>
                                                        </v-col>
                                                        <v-col>
                                                            <v-text-field label="กรอกข้อมูลสถานที่ฝึกอบรม" type="text"
                                                                variant="outlined"
                                                    ...
                                                    <v-row>
                                                        <v-col>
                                                            <v-text-field label="กรอกข้อมูลผู้จัดการฟาร์ม/ผู้ประเมินผล"
