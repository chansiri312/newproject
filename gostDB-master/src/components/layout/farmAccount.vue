                              ...
                              <div class="text">
                                 <v-sheet class="form mx-auto" elevation="1" max-width="900" min-height="500"
                                    ...
                                    <div class="forminput">
                                       ...
                                       <v-row>
                                          <v-col>
                                             <v-text-field label="กรอกข้อมูลวัน/เดือน/ปี" type="text" variant="outlined"
                                                v-model="recipe.ingredient1"></v-text-field>
                                          </v-col>
                                          <v-col>
                                             <v-text-field label="กรอกข้อมูลจำนวนการเข้า" type="text" variant="outlined"
                                                v-model="recipe.ingredient2"></v-text-field>
                                          </v-col>
                                       </v-row>
                                       <v-row>
                                          <v-col>
                                             <v-text-field label="กรอกข้อมูลจำนวนออก" type="text" variant="outlined"
                                                v-model="recipe.ingredient3"></v-text-field>
                                          </v-col>
                                          <v-col>
                                             <v-text-field label="กรอกข้อมูลจำนวนการสูญเสีย" type="text" variant="outlined"
                                                v-model="recipe.ingredient4"></v-text-field>
                                          </v-col>
                                       </v-row>
                                       <v-row>
                                          <v-col>
                                             <v-text-field label="กรอกข้อมูลจำนวนแพะลูกเกิด" type="text" variant="outlined"
                                                v-model="recipe.ingredient5"></v-text-field>
                                          </v-col>
                                          <v-col>
                                             <v-text-field label="กรอกข้อมูลจำนวนแม่แพะรีดนม" type="text"
                                                variant="outlined" v-model="recipe.ingredient6"></v-text-field>
                                          </v-col>
                                       </v-row>
                                       <v-row>
                                          <v-col>
                                             <v-text-field label="กรอกข้อมูลจำนวนป่วย" type="text" variant="outlined"
                                                v-model="recipe.ingredient7"></v-text-field>
                                          </v-col>
                                          <v-col>
                                             <v-text-field label="กรอกข้อมูลรวมทั้งหมด" type="text" variant="outlined"
                                       ...
                                       <v-row justify="center" style="margin-bottom: 2rem">
                                          ...
                                          <div style="margin-left: 1rem">
                                             <v-btn color="red" width="120" height="50" @click="dialog = false"> ยกเลิก
                                             </v-btn>
                                          </div>
                                       </v-row>
