                    ...
                    <div class="text">
                      ...
                      >
                        <div class="forminput">
                          ...
                          <v-col>
                            <v-text-field
                              label="กรอกข้อมูลหมายเลขแพะ"
                              type="text"
                              variant="outlined"
                              v-model="recipe.number"
                            ></v-text-field>
                          </v-col>
                          ...
                          <v-row>
                            <v-col>
                              <v-text-field
                                label="กรอกข้อมูลปริมาณน้ำนมช่วงเช้า"
                                type="text"
                                variant="outlined"
                                v-model="recipe.milk_morning"
                              ></v-text-field>
                            </v-col>
                            <v-col>
                              <v-text-field
                                label="กรอกข้อมูลปริมาณน้ำนมช่วงเย็น"
                                type="text"
                                variant="outlined"
                                v-model="recipe.milk_evning"
                              ></v-text-field> </v-col
                          ></v-row>
                          <v-row>
                            <v-col>
                              <v-text-field
                                label="กรอกข้อมูลรวมปริมาณน้ำนม"
                                type="text"
                                variant="outlined"
                                v-model="recipe.total_milk"
                              ></v-text-field>
                            </v-col>
                            <v-col>
                              <v-text-field
