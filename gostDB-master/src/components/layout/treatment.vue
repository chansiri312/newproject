                      ...
                      >
                        <div class="forminput">
                          ...
                          <v-row>
                            ...
                            <v-col>
                              <v-text-field
                                label="กรอกข้อมูลหมายเลขประจำตัว"
                                type="text"
                                variant="outlined"
                          ...
                          <v-row>
                            <v-col>
                              <v-text-field
                                label="กรอกข้อมูลข้อมูลสุขภาพ"
                                type="text"
                                variant="outlined"
                                v-model="recipe.health_gost"
                              ></v-text-field>
                            </v-col>
                          ...
                          <v-row>
                            <v-col>
                              <v-text-field
                                label="กรอกข้อมูลการรักษาและผลการรักษา"
                                type="text"
                                variant="outlined"
                                v-model="recipe.drug_result"
                              ></v-text-field>
                            </v-col>
                            <v-col>
                              <v-text-field
                                label="กรอกชื่อผู้รักษา"
                                type="text"
                                variant="outlined"
                                v-model="recipe.name_doctor"
                              ></v-text-field>
                            </v-col>
                          </v-row>
                          <v-row>
