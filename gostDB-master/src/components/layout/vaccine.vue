                      ...
                      >
                        <div class="forminput">
                          <v-col class="text-center" style="margin-bottom: 1rem">
                            <h3>แบบบันทึกข้อมูลการใช้วัคซีน-การถ่ายพยาธิ(ทั้งฝูง)</h3>
                          </v-col>
                          <v-row>
                            <v-col>
                              <v-text-field
                            ...
                            <v-col>
                              <v-text-field
                                label="กรอกข้อมูลคอก/ฝูง"
                                type="text"
                                variant="outlined"
                                v-model="recipe.num_herd_goats"
                              ></v-text-field>
                            </v-col>
                          </v-row>
                          <v-row>
                            <v-col>
                              <v-text-field
                                label="กรอกข้อมูลชนิด/ชื่อวัคซีน"
                                type="text"
                                variant="outlined"
                                v-model="recipe.name_vaccine"
                              ></v-text-field>
                            </v-col>
                            <v-col>
                              <v-text-field
                                label="กรอกข้อมูลจำนวนแพะนม(ตัว)"
                                type="text"
                                variant="outlined"
                                v-model="recipe.num_gost"
                              ></v-text-field>
                            </v-col>
                          </v-row>
                          ...
                          <v-row>
                            <v-col>
                              <v-text-field
                                label="กรอกข้อมูลชนิด/ชื่อยา"
                                type="text"
                                variant="outlined"
                                v-model="recipe.name_drug_deworming"
                              ></v-text-field>
                            </v-col>
                            <v-col>
                              <v-text-field
                                label="กรอกข้อมูลจำนวนแพะ(ตัว)"
                                type="text"
                                variant="outlined"
                                v-model="recipe.num_gost_deworming"
                              ></v-text-field>
                            </v-col>
                          </v-row>
                          <div class="text-center" style="margin-bottom: 1rem">
                            <h4>การตรวจโรคบรูเซลโลซีล</h4>
                          </div>
                          <v-row>
                            <v-col>
                              <v-text-field
                                label="กรอกข้อมูลการตรวจโรคบรูเซลโลซีล"
                                type="text"
                                variant="outlined"
                                v-model="recipe.data_Brucellosis"
                              ></v-text-field>
                            </v-col>
                            <v-col>
                              <v-text-field
                                label="กรอกชื่อผู้ปฏิบัติงาน"
                                type="text"
                                variant="outlined"
                            ...
                            <v-col>
                              <v-text-field
                                label="กรอกชื่อผู้ควบคุม"
                                type="text"
                                variant="outlined"
                                v-model="recipe.headman"
                              ></v-text-field>
                            </v-col>
                          </v-row>
...
function showMyData() {
  if (user !== null) {
    user.providerData.forEach(async (profile) => {
      ...
      const q = query(collection(db, 'addvaccine'), where('useremail', '==', userEmail))
