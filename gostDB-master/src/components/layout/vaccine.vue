                                            ...
                                            <v-sheet class="form mx-auto" elevation="1" max-width="900" min-height="500"
                                                ...
                                                <div class="forminput">
                                                    ...
                                                    <v-row>
                                                        ...
                                                        <v-col>
                                                            <v-text-field label="กรอกข้อมูลคอก/ฝูง" type="text"
                                                                variant="outlined"
                                                    ...
                                                    <v-row>
                                                        <v-col>
                                                            <v-text-field label="กรอกข้อมูลชนิด/ชื่อวัคซีน" type="text"
                                                                variant="outlined"
                                                                v-model="recipe.ingredient3"></v-text-field>
                                                        </v-col>
                                                        <v-col>
                                                            <v-text-field label="กรอกข้อมูลจำนวนแพะนม(ตัว)" type="text"
                                                                variant="outlined"
                                                    ...
                                                    <v-row>
                                                        <v-col>
                                                            <v-text-field label="กรอกข้อมูลชนิด/ชื่อยา" type="text"
                                                                variant="outlined"
                                                                v-model="recipe.ingredient3"></v-text-field>
                                                        </v-col>
                                                        <v-col>
                                                            <v-text-field label="กรอกข้อมูลจำนวนแพะ(ตัว)" type="text"
                                                                variant="outlined"
                                                                v-model="recipe.ingredient4"></v-text-field>
                                                        </v-col>
                                                    </v-row>
                                                    ...
                                                    <v-row>
                                                        <v-col>
                                                            <v-text-field label="กรอกข้อมูลการตรวจโรคบรูเซลโลซีล"
                                                                type="text" variant="outlined"
                                                                v-model="recipe.ingredient3"></v-text-field>
                                                        </v-col>
                                                        <v-col>
                                                            <v-text-field label="กรอกชื่อผู้ปฏิบัติงาน" type="text"
                                                                variant="outlined"
                                                                v-model="recipe.ingredient4"></v-text-field>
                                                        </v-col>
                                                        <v-col>
                                                            <v-text-field label="กรอกชื่อผู้ควบคุม" type="text"
                                                                variant="outlined"
                                                                v-model="recipe.ingredient4"></v-text-field>
                                                        </v-col>
                                                    </v-row>
