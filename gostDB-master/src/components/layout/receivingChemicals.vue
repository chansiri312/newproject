                                            ...
                                            <v-sheet class="form mx-auto" elevation="1" max-width="900" min-height="500"
                                                ...
                                                <div class="forminput">
                                                    ...
                                                    <v-col class="text-center" style="margin-bottom: 1rem">
                                                        <h3>แบบบันทึกข้อมูลการการรับ-จ่ายเวชภัณฑ์และสารเคมี</h3>
                                                    </v-col>
                                                    <v-row>
                                                        <v-col>
                                                            <v-text-field label="กรอกชื่อของเวชภัณฑ์" type="text"
                                                                variant="outlined"
                                                                v-model="recipe.ingredient1"></v-text-field>
                                                        </v-col>
                                                        <v-col>
                                                            <v-text-field label="กรอกชื่อสารเคมี" type="text"
                                                                variant="outlined"
                                                    ...
                                                    <v-row>
                                                        <v-col>
                                                            <v-text-field label="จำนวนที่ซื้อ/ยกมาวัน/เดือน/ปี" type="text"
                                                                variant="outlined"
                                                                v-model="recipe.ingredient3"></v-text-field>
                                                        </v-col>
                                                        <v-col>
                                                            <v-text-field label="กรอกจำนวนที่ใช้ วัน/เดือน/ปี" type="text"
                                                                variant="outlined"
                                                                v-model="recipe.ingredient4"></v-text-field>
                                                        </v-col>
                                                        <v-col>
                                                            <v-text-field label="กรอกข้อมูลคงเหลือ" type="text"
                                                                variant="outlined"
...
function showMyData() {
    if (user !== null) {
        user.providerData.forEach(async (profile) => {
            ...
            const q = query(collection(db, 'addreceivingChemicals'), where('useremail', '==', userEmail))
