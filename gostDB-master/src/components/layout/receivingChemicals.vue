                      ...
                      >
                        <div class="forminput">
                          ...
                          <v-row>
                            <v-col>
                              <v-text-field
                                label="กรอกชื่อของเวชภัณฑ์"
                                type="text"
                                variant="outlined"
                                v-model="recipe.name_drug"
                              ></v-text-field>
                            </v-col>
                            <v-col>
                              <v-text-field
                                label="กรอกชื่อสารเคมี"
                                type="text"
                                variant="outlined"
                                v-model="recipe.name_chemical"
                              ></v-text-field>
                            </v-col>
                          </v-row>
                          <v-row>
                            <v-col>
                              <v-text-field
                                label="จำนวนที่ซื้อ/ยกมาวัน/เดือน/ปี"
                                type="text"
                                variant="outlined"
                                v-model="recipe.num_date"
                              ></v-text-field>
                            </v-col>
                            <v-col>
                              <v-text-field
                                label="กรอกจำนวนที่ใช้ วัน/เดือน/ปี"
                                type="text"
                                variant="outlined"
                                v-model="recipe.numuse_date"
                              ></v-text-field>
                            </v-col>
                            <v-col>
                              <v-text-field
                                label="กรอกข้อมูลคงเหลือ"
                                type="text"
                                variant="outlined"
