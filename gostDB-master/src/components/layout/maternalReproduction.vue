                                            ...
                                            <v-sheet class="form mx-auto" elevation="1" max-width="900" min-height="500"
                                                ...
                                                <div class="forminput">
                                                    ...
                                                    <v-col class="text-center" style="margin-bottom: 1rem">
                                                        <h3>แบบบันทึกข้อมูลการสืบพันธุ์ของแม่พันธุ์</h3>
                                                    </v-col>
                                                    <v-row>
                                                        <v-col>
                                                            <v-text-field label="กรอกวัน/เดือน/ปี(ที่ผสมพันธุ์)" type="text"
                                                                variant="outlined"
                                                                v-model="recipe.ingredient1"></v-text-field>
                                                        </v-col>
                                                        <v-col>
                                                            <v-text-field label="กรอกชื่อพ่อแพะที่ใช้ผสมพันธุ์" type="text"
                                                                variant="outlined"
                                                    ...
                                                    <v-row>
                                                        <v-col>
                                                            <v-text-field label="กรอกอายุเมื่อผสมพันธุ์" type="text"
                                                                variant="outlined"
                                                                v-model="recipe.ingredient3"></v-text-field>
                                                        </v-col>
                                                        <v-col>
                                                            <v-text-field label="กรอกข้อมูลกำหนดวันคลอด" type="text"
                                                                variant="outlined"
                                                    ...
                                                    <v-row>
                                                        <v-col>
                                                            <v-text-field label="กรอกข้อมูลลูกที่เกิด" type="text"
                                                                variant="outlined"
                                                                v-model="recipe.ingredient5"></v-text-field>
                                                        </v-col>
                                                        <v-col>
                                                            <v-text-field label="กรอกข้อมูลวัน/เดือน/ปีของลูกที่คลอด"
                                                    ...
                                                    <v-row>
                                                        <v-col>
                                                            <v-text-field label="กรอกข้อมูลหมายเลข" type="text"
                                                                variant="outlined"
                                                                v-model="recipe.ingredient7"></v-text-field>
                                                        </v-col>
                                                        <v-col>
                                                            <v-select label="เพศ" variant="outlined"
                                                                :items="['เพศผู้', 'เพศเมีย']"></v-select>
                                                        </v-col>
                                                    </v-row>
                                                    <v-row>
                                                        <v-col>
...
function showMyData() {
    if (user !== null) {
        user.providerData.forEach(async (profile) => {
            ...
            const q = query(collection(db, 'addrmaternalReproduction'), where('useremail', '==', userEmail))
