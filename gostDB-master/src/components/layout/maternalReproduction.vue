                      ...
                      >
                        <div class="forminput">
                          ...
                          <v-row>
                            <v-col>
                              <v-text-field
                                label="กรอกวัน/เดือน/ปี(ที่ผสมพันธุ์)"
                                type="text"
                                variant="outlined"
                                v-model="recipe.dad_breed"
                              ></v-text-field>
                            </v-col>
                            <v-col>
                              <v-text-field
                                label="กรอกชื่อพ่อแพะที่ใช้ผสมพันธุ์"
                                type="text"
                                variant="outlined"
                                v-model="recipe.dad_breed"
                              ></v-text-field>
                          ...
                          <v-row>
                            <v-col>
                              <v-text-field
                                label="กรอกอายุเมื่อผสมพันธุ์"
                                type="text"
                                variant="outlined"
                                v-model="recipe.old_breed"
                              ></v-text-field>
                            </v-col>
                            <v-col>
                              <v-text-field
                                label="กรอกข้อมูลกำหนดวันคลอด"
                                type="text"
                                variant="outlined"
                                v-model="recipe.birth_day"
                              ></v-text-field>
                            </v-col>
                          </v-row>
                          <v-row>
                            <v-col>
                              <v-text-field
                                label="กรอกข้อมูลลูกที่เกิด"
                                type="text"
                                variant="outlined"
                                v-model="recipe.gost_birthday"
                              ></v-text-field>
                            </v-col>
                            <v-col>
                              <v-text-field
                                label="กรอกข้อมูลวัน/เดือน/ปีของลูกที่คลอด"
                                type="text"
                                variant="outlined"
                                v-model="recipe.date_birthday"
                              ></v-text-field>
                            </v-col>
                          </v-row>
                          <v-row>
...
function showMyData() {
  if (user !== null) {
    user.providerData.forEach(async (profile) => {
      ...
      const q = query(
        collection(db, 'addrmaternalReproduction'),
